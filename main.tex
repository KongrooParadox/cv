...
\iftutex
  ...
  \setmainfont{Route 159}
  \setsansfont{Route 159}
...
\definecolor{LightBlue}{HTML}{3d98d1}
\definecolor{NixOSDarkBlue}{HTML}{4d6fb7}
\definecolor{IndianGold}{HTML}{cbaa4b}
\colorlet{name}{black}
\colorlet{tagline}{NixOSDarkBlue}
\colorlet{heading}{NixOSDarkBlue}
\colorlet{headingrule}{IndianGold}
...
\personalinfo{%
  \email{jobs.gnanty@proton.me}
  \phone{(+212) 649380257}
  \github{KongrooParadox}
  \linkedin{guillaume_nanty_30_en}
  \location{Oujda, MOROCCO}
  \printinfo{\faBirthdayCake}{35 years old}
  % \homepage{kongrooparadox.github.io}
  % \mailaddress{My address, POSTAL CODE}
...
\cvevent{Freelance – Production Engineer}{FDJ United}{Jan 2024 -- Sep 2026}{Vitrolles, France (13)}
...
\wheelchart{1.5cm}{0.7cm}{%
  4/6em/accent!30/{Terraform, Ansible},
  6/3em/accent!40/Git,
